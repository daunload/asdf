    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (result && !result.success) {
                setError(result.error || '온보딩 정보 저장 중 오류가 발생했습니다.');
                setIsSubmitting(false);
            }
            ...
            setError('온보딩 정보 저장 중 오류가 발생했습니다. 다시 시도해주세요.');
            setIsSubmitting(false);
        }
    };
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <Input
                                        ...
                                        className="w-full"
                                        aria-label="출생 연도"
                                        aria-invalid={error && error.includes('연도') ? 'true' : 'false'}
                                        aria-describedby={error && error.includes('연도') ? 'error-message' : undefined}
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <Input
                                        ...
                                        className="w-full"
                                        aria-label="출생 월"
                                        aria-invalid={error && error.includes('월') ? 'true' : 'false'}
                                        aria-describedby={error && error.includes('월') ? 'error-message' : undefined}
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <Input
                                        ...
                                        className="w-full"
                                        aria-label="출생 일"
                                        aria-invalid={error && error.includes('일') || error.includes('날짜') ? 'true' : 'false'}
                                        aria-describedby={error && (error.includes('일') || error.includes('날짜')) ? 'error-message' : undefined}
                                    />
                                </div>
                            </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            className="w-full"
                                            aria-label="출생 시"
                                            aria-invalid={error && error.includes('시간') ? 'true' : 'false'}
                                            aria-describedby={error && error.includes('시간') ? 'error-message' : undefined}
                                        />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            className="w-full"
                                            aria-label="출생 분"
                                            aria-invalid={error && error.includes('분') ? 'true' : 'false'}
                                            aria-describedby={error && error.includes('분') ? 'error-message' : undefined}
                                        />
                                    </div>
                                </div>
                                ...
                                {isTimeUnknown && (
                                    ...
                                    >
                                        <p className="text-sm text-yellow-800 dark:text-yellow-200">
                                            시간을 모르면 제한된 해석만 제공됩니다. 정확한 해석을 위해서는 출생 시간이 필요합니다.
                                        </p>
                                    </div>
                                )}
                            </div>
