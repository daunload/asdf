...
export function CardsPage() {
    ...
    const [error, setError] = useState<{ message: string; code?: string; retry?: boolean } | null>(
        null
    );
        ...
        async function fetchCards() {
            ...
            try {
                ...
                if (!response.ok) {
                    ...
                    throw new Error(errorData.error || '카드를 불러오는 중 오류가 발생했습니다.');
                }
                ...
                setError({
                    message: err.message || '카드를 불러오는 중 오류가 발생했습니다.',
                ...
                >
                    {isFreeCard ? (
                        ...
                        <Card
                            ...
                            topicName={getTopicById(cards[currentIndex].topicId)?.name}
                        ...
                        // 잠금 카드 (유료 주제)
                        <LockedCard
                            topicName={paidTopics[currentIndex - cards.length].name}
                            currentIndex={currentIndex}
                            totalCount={totalCards}
